...
export const Welcome = () => {
    return (
        <div id="welcomeDiv" className="container-fluid">
            ...
            <div className="row">
                <div className="col-sm-5 col-sm-offset-1 text-center">
                    ...
                    <br/>
                    <img className="welcomeIcon" src="/statics/musicIcon.png" />
                    <span className="welcomeText">Royalty-Free Music</span>
                    <br/>
                    <img className="welcomeIcon" src="/statics/gridIcon.png" alt=""/>
                ...
                <div className="col-sm-5 col-sm-offset-1 text-center">
                    ...
                    <br/>
                    <img className="welcomeIcon" src="/statics/gearIcon.png"/>
                    <span className="welcomeText">Property Management in a Single Dashboard</span>
                    <br/>
                    <img className="welcomeIcon" src="/statics/personalizedWebIcon.png" alt=""/>
                    <span className="welcomeText">Personalized Agent Website</span>
                    <br/>
                    ...
                    <br/>
                    <img className="welcomeIcon" src="/statics/bellIcon.png"/>
